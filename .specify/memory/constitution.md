# Headmaster Constitution

## Core Principles

### I. Multi-Agent AI Integration

Headmaster serves as a unified desktop interface for multiple AI terminal agents (Gemini CLI, Claude Code, Qwen Code, etc.). Each AI agent integration must be:

...
cd ../Adonis Core && cargo install --path crates/headmaster-app
...
| `HEADMASTER_CDP_PORT`            | `0`   | CDP disabled             |
...
```bash
# Clean via database
sqlite3 "~/Library/Application Support/Headmaster-Dev/headmaster/headmaster.db" \

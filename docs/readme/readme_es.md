...
<p align="center">
  <strong>Una app Work Along gratuita y de código abierto con AI Agents</strong><br>
...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <strong>Español</strong> | <a href="./readme_pt.md">Português</a> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <a href="./readme_uk.md">Українська</a> | <a href="https://www.gcaplabs.com" target="_blank">Sitio oficial</a>
</p>

<p align="center">
  <strong>💬 Comunidad:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-11.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/Headmaster" target="_blank">Twitter</a>
</p>
...
[✨ Work Along en acción](#-cowork-en-acción) ·
[🤔 ¿Por qué elegir Headmaster?](#-por-qué-elegir-headmaster-sobre-claude-cowork) ·
...
## Work Along — AI Agents que trabajan contigo
...
Headmaster viene con un motor de Agent AI completo. A diferencia de las herramientas que requieren instalar CLI Agents por separado, **Headmaster funciona en el momento en que lo instalas**.
...
- **Asistentes listos para usar** — 21 asistentes profesionales integrados (Work Along, PPT Creator, Morph PPT, Morph PPT 3D, Word Creator, Word Form Creator, Excel Creator, Pitch Deck Creator, Dashboard Creator, Academic Paper Writer, Financial Model Creator y más) listos para usar de inmediato
...
Si ya usas Claude Code, Codex, Hermes Agent u OpenClaw, Headmaster los detecta automáticamente y te permite hacer Work Along con todos ellos — junto con el Agent integrado.

**Agents compatibles:** Agent integrado (configuración cero) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI (aionrs, el servicio backend en Rust distribuido con Headmaster) • Snow CLI • Hermes Agent • Cursor Agent y más
...
- **Interfaz unificada** — una plataforma Work Along para todos tus AI Agents
...
### The Council — Colaboración Multi-Agent Coordinada
...
- **Ejecución paralela multi-agent** — Leader divide las tareas en subtareas y las delega a agentes Teammate que se ejecutan en paralelo; cada Teammate usa su propio modelo a través de ACP (Agent Communication Protocol, la capa de coordinación multi-agent de Headmaster), Gemini o Aionrs
...
<details>
<summary><strong>🔍 Ver detalles del The Council ▶️</strong></summary>
...
## Cualquier clave API, poder completo del Work Along Agent
...
Headmaster también admite el servicio de puerta de enlace [NewAPI](https://github.com/QuantumNous/new-api) — un centro unificado de modelos AI que agrega y distribuye varios LLMs. Cambia flexiblemente entre diferentes modelos en la misma interfaz para satisfacer diversos requisitos de tareas.
...
- **Habilidades de tres niveles** — Habilidades integradas (incluidas con Headmaster), habilidades personalizadas (las tuyas) y habilidades de Extension (aportadas por extensiones de terceros); habilita/deshabilita por conversación con el indicador de habilidades
...
Headmaster incluye **21 asistentes profesionales** con capacidades predefinidas, extensibles a través de habilidades personalizadas:

- **🤝 Work Along** — Ejecución autónoma de tareas (operaciones de archivos, procesamiento de documentos, planificación de flujos de trabajo)
...
**Habilidades personalizadas**: Crea habilidades en el directorio `skills/`, habilita/deshabilita habilidades para asistentes para extender las capacidades AI. Las habilidades provienen de tres fuentes: integradas (incluidas con Headmaster), personalizadas (las tuyas) y Extension (aportadas a través del SDK de Extension). Las habilidades integradas incluyen `pptx`, `docx`, `pdf`, `xlsx`, `mermaid` y más.
...
## Work Along desde cualquier lugar

_Tu asistente AI 24/7 — accede a Headmaster desde cualquier dispositivo, en cualquier lugar._
...
- **Integración de plataformas de chat**
  - **Telegram** — Haz Work Along con tu AI Agent directamente desde Telegram
  - **Lark (Feishu)** — Work Along a través de bots Feishu para colaboración empresarial
...
> **Configuración:** Headmaster Settings → WebUI Settings → Channel, configura el Bot Token.
...
> [Tutorial de acceso remoto a Internet](https://github.com/iOfficeAI/Headmaster/wiki/Remote-Internet-Access-Guide-Chinese)

## ✨ Work Along en acción

### **Tareas programadas — Work Along en piloto automático**
...
- **Evitar suspensión** — Headmaster previene automáticamente la suspensión del sistema mientras las tareas están activas y detecta activaciones perdidas tras el despertar
...
_Renombrado por lotes, organización automática, clasificación inteligente, fusión de archivos — el Work Along Agent lo maneja por ti._
...
> [Guía de configuración del modelo de generación de imágenes](https://github.com/iOfficeAI/Headmaster/wiki/Headmaster-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 ¿Por qué elegir Headmaster sobre Claude Work Along?
...
R: <strong>No.</strong> Headmaster tiene un AI Agent integrado que funciona inmediatamente después de la instalación. Solo ingresa cualquier clave API para empezar. Si también tienes herramientas CLI como Claude Code o Gemini CLI instaladas, Headmaster las detectará e integrará automáticamente para aún más capacidades.
</details>

<details>
<summary><strong>P: ¿Qué puedo hacer con Headmaster?</strong></summary>
R: Headmaster es tu <strong>espacio de trabajo Work Along privado</strong>. El Agent integrado puede organizar carpetas por lotes, procesar datos de Excel, generar documentos, buscar en la web y generar imágenes. Con el Modo Multi-Agent, también puedes aprovechar Claude Code, Codex y otros Agents CLI poderosos a través de la misma interfaz.
</details>

<details>
<summary><strong>P: ¿Es gratis?</strong></summary>
R: Headmaster es completamente gratuito y de código abierto. Solo pagas por el uso de la API del proveedor que elijas, y puedes usar claves API de cualquier proveedor que prefieras.
</details>
...
## Ver cómo la gente usa Headmaster
...
- [Work Along gratuito de código abierto, integración completa de modelos + operaciones de archivos autónomas](https://mp.weixin.qq.com/s/F3f-CCsVPaK3lK00jXhOOg) — Implementación de proyecto AI de código abierto
...
> **¿Hiciste un video sobre Headmaster?** [Avísanos en X](https://x.com/Headmaster) y lo destacaremos aquí!
...
1. **Instalar** Headmaster
2. **Ingresa** cualquier clave API para empezar
3. **Comenzar a hacer Work Along** — el AI Agent integrado está listo para usar
...
- [📖 Guía de instalación completa](https://github.com/iOfficeAI/Headmaster/wiki/Getting-Started) — Pasos detallados desde la descarga hasta la configuración
- [⚙️ Guía de configuración LLM](https://github.com/iOfficeAI/Headmaster/wiki/LLM-Configuration) — Configuración de modelos AI multiplataforma
- [🤖 Configuración del modo Multi-Agent](https://github.com/iOfficeAI/Headmaster/wiki/ACP-Setup) — Integrar Agents AI de terminal
- [🔌 Configuración de herramientas MCP](https://github.com/iOfficeAI/Headmaster/wiki/MCP-Configuration-Guide) — Configuración del servidor Model Context Protocol
- [🌐 Guía de configuración WebUI](https://github.com/iOfficeAI/Headmaster/wiki/WebUI-Configuration-Guide) — Tutorial completo de configuración y configuración de WebUI

**🎯 Casos de uso**

- [📁 Gestión de archivos](https://github.com/iOfficeAI/Headmaster/wiki/file-management) — Organización inteligente de archivos
- [📊 Procesamiento de Excel](https://github.com/iOfficeAI/Headmaster/wiki/excel-processing) — Procesamiento de datos impulsado por AI
- [🎨 Generación de imágenes](https://github.com/iOfficeAI/Headmaster/wiki/Headmaster-Image-Generation-Tool-Model-Configuration-Guide) — Creación de imágenes AI
- [📚 Más casos de uso](https://github.com/iOfficeAI/Headmaster/wiki/Use-Cases-Overview)

**❓ Soporte y ayuda**

- [❓ FAQ](https://github.com/iOfficeAI/Headmaster/wiki/FAQ) — Preguntas y solución de problemas
- [🔧 Tutoriales de configuración y uso](https://github.com/iOfficeAI/Headmaster/wiki/Configuration-Guides) — Documentación de configuración completa
...
- [GitHub Discussions](https://github.com/iOfficeAI/Headmaster/discussions) — comparte ideas e intercambia consejos
- [Reportar problemas](https://github.com/iOfficeAI/Headmaster/issues) — errores y solicitudes de funciones
- [Actualizaciones de lanzamiento](https://github.com/iOfficeAI/Headmaster/releases) — obtén la última versión
...
[Reportar error](https://github.com/iOfficeAI/Headmaster/issues) · [Solicitar función](https://github.com/iOfficeAI/Headmaster/issues)

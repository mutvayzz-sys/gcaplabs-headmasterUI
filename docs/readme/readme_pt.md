...
<p align="center">
  <strong>Um app Work Along gratuito e de código aberto com AI Agents</strong><br>
...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <strong>Português</strong> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <a href="./readme_uk.md">Українська</a> | <a href="https://www.gcaplabs.com" target="_blank">Site oficial</a>
</p>

<p align="center">
  <strong>💬 Comunidade:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-11.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/Headmaster" target="_blank">Twitter</a>
</p>
...
[✨ Work Along em ação](#-cowork-em-ação) ·
[🤔 Por que escolher Headmaster?](#-por-que-escolher-headmaster-sobre-claude-cowork) ·
...
## Work Along — AI Agents que trabalham com você
...
Headmaster vem com um motor de Agent AI completo. Diferente de ferramentas que exigem instalar CLI Agents separadamente, **Headmaster funciona no momento em que você o instala**.
...
- **Assistentes prontos para usar** — 21 assistentes profissionais integrados (Work Along, PPT Creator, Morph PPT, Morph PPT 3D, Word Creator, Word Form Creator, Excel Creator, Pitch Deck Creator, Dashboard Creator, Academic Paper Writer, Financial Model Creator e mais) prontos para usar imediatamente
...
Se você já usa Claude Code, Codex, Hermes Agent ou OpenClaw, Headmaster os detecta automaticamente e permite fazer Work Along com todos eles — junto com o Agent integrado.

**Agents compatíveis:** Agent integrado (configuração zero) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI (aionrs, o serviço backend em Rust distribuído com o Headmaster) • Snow CLI • Hermes Agent • Cursor Agent e mais
...
- **Interface unificada** — uma plataforma Work Along para todos os seus AI Agents
...
### The Council — Colaboração Multi-Agent Coordenada
...
- **Execução paralela multi-agent** — Leader divide as tarefas em subtarefas e delega para agentes Teammate que executam em paralelo; cada Teammate usa seu próprio modelo via ACP (Agent Communication Protocol, a camada de coordenação multi-agent do Headmaster), Gemini ou Aionrs
...
<details>
<summary><strong>🔍 Ver detalhes do The Council ▶️</strong></summary>
...
## Qualquer chave API, poder completo do Work Along Agent
...
Headmaster também suporta o serviço de gateway [NewAPI](https://github.com/QuantumNous/new-api) — um hub unificado de modelos AI que agrega e distribui vários LLMs. Alterne flexivelmente entre diferentes modelos na mesma interface para atender a vários requisitos de tarefas.
...
- **Habilidades de três camadas** — Habilidades integradas (incluídas com o Headmaster), habilidades personalizadas (suas próprias) e habilidades de Extension (contribuídas por extensões de terceiros); habilite/desabilite por conversa com o indicador de habilidades
...
Headmaster inclui **21 assistentes profissionais** com capacidades predefinidas, extensíveis através de habilidades personalizadas:

- **🤝 Work Along** — Execução autônoma de tarefas (operações de arquivos, processamento de documentos, planejamento de fluxo de trabalho)
...
## Work Along de qualquer lugar

_Seu assistente AI 24/7 — acesse Headmaster de qualquer dispositivo, em qualquer lugar._
...
- **Integração de plataformas de chat**
  - **Telegram** — Faça Work Along com seu AI Agent diretamente do Telegram
  - **Lark (Feishu)** — Work Along através de bots Feishu para colaboração empresarial
...
> **Configuração:** Headmaster Settings → WebUI Settings → Channel, configure o Bot Token.
...
> [Tutorial de acesso remoto à Internet](https://github.com/iOfficeAI/Headmaster/wiki/Remote-Internet-Access-Guide-Chinese)

## ✨ Work Along em ação

### **Tarefas agendadas — Work Along no piloto automático**
...
- **Evitar suspensão** — O Headmaster previne automaticamente a suspensão do sistema enquanto as tarefas estão ativas e detecta acionamentos perdidos após o despertar
...
_Renomeação em lote, organização automática, classificação inteligente, mesclagem de arquivos — o Work Along Agent cuida disso para você._
...
> [Guia de configuração do modelo de geração de imagens](https://github.com/iOfficeAI/Headmaster/wiki/Headmaster-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Por que escolher Headmaster sobre Claude Work Along?
...
R: <strong>Não.</strong> Headmaster tem um AI Agent integrado que funciona imediatamente após a instalação. Basta inserir qualquer chave API para começar. Se você também tiver ferramentas CLI como Claude Code ou Gemini CLI instaladas, Headmaster as detectará e integrará automaticamente para ainda mais capacidades.
</details>

<details>
<summary><strong>P: O que posso fazer com Headmaster?</strong></summary>
R: Headmaster é seu <strong>espaço de trabalho Work Along privado</strong>. O Agent integrado pode organizar pastas em lote, processar dados do Excel, gerar documentos, buscar na web e gerar imagens. Com o Modo Multi-Agent, você também pode aproveitar Claude Code, Codex e outros Agents CLI poderosos através da mesma interface.
</details>

<details>
<summary><strong>P: É gratuito?</strong></summary>
R: Headmaster é completamente gratuito e de código aberto. Você paga apenas pelo uso da API do provedor que escolher, e pode usar chaves API de qualquer provedor que preferir.
</details>
...
## Veja como as pessoas usam Headmaster
...
- [Work Along gratuito de código aberto, integração completa de modelos + operações de arquivos autônomas](https://mp.weixin.qq.com/s/F3f-CCsVPaK3lK00jXhOOg) — Implementação de projeto AI de código aberto
...
> **Fez um vídeo sobre Headmaster?** [Avise-nos no X](https://x.com/Headmaster) e vamos destacá-lo aqui!
...
1. **Instale** Headmaster
2. **Insira** qualquer chave API para começar
3. **Comece a fazer Work Along** — o AI Agent integrado está pronto para usar
...
- [📖 Guia de instalação completo](https://github.com/iOfficeAI/Headmaster/wiki/Getting-Started) — Passos detalhados do download à configuração
- [⚙️ Guia de configuração LLM](https://github.com/iOfficeAI/Headmaster/wiki/LLM-Configuration) — Configuração de modelos AI multiplataforma
- [🤖 Configuração do modo Multi-Agent](https://github.com/iOfficeAI/Headmaster/wiki/ACP-Setup) — Integrar Agents AI de terminal
- [🔌 Configuração de ferramentas MCP](https://github.com/iOfficeAI/Headmaster/wiki/MCP-Configuration-Guide) — Configuração do servidor Model Context Protocol
- [🌐 Guia de configuração WebUI](https://github.com/iOfficeAI/Headmaster/wiki/WebUI-Configuration-Guide) — Tutorial completo de configuração e instalação do WebUI

**🎯 Casos de uso**

- [📁 Gerenciamento de arquivos](https://github.com/iOfficeAI/Headmaster/wiki/file-management) — Organização inteligente de arquivos
- [📊 Processamento de Excel](https://github.com/iOfficeAI/Headmaster/wiki/excel-processing) — Processamento de dados alimentado por AI
- [🎨 Geração de imagens](https://github.com/iOfficeAI/Headmaster/wiki/Headmaster-Image-Generation-Tool-Model-Configuration-Guide) — Criação de imagens AI
- [📚 Mais casos de uso](https://github.com/iOfficeAI/Headmaster/wiki/Use-Cases-Overview)

**❓ Suporte e ajuda**

- [❓ FAQ](https://github.com/iOfficeAI/Headmaster/wiki/FAQ) — Perguntas e solução de problemas
- [🔧 Tutoriais de configuração e uso](https://github.com/iOfficeAI/Headmaster/wiki/Configuration-Guides) — Documentação de configuração completa
...
- [GitHub Discussions](https://github.com/iOfficeAI/Headmaster/discussions) — compartilhe ideias e troque dicas
- [Reportar problemas](https://github.com/iOfficeAI/Headmaster/issues) — bugs e solicitações de recursos
- [Atualizações de lançamento](https://github.com/iOfficeAI/Headmaster/releases) — obtenha a última versão
...
[Reportar bug](https://github.com/iOfficeAI/Headmaster/issues) · [Solicitar recurso](https://github.com/iOfficeAI/Headmaster/issues)

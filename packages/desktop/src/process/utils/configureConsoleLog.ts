 ...
 *   - macOS:   ~/Library/Logs/Headmaster/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\Headmaster\logs\YYYY-MM-DD.log
 *   - Linux:   ~/.config/Headmaster/logs/YYYY-MM-DD.log
 *

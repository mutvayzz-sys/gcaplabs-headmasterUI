...
export const PROTOCOL_SCHEME = 'headmaster';

/**
 * Parse a headmaster:// URL into action and params.
 * Supports two formats:
 *   1. headmaster://add-provider?base_url=xxx&api_key=xxx
 *   2. headmaster://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */

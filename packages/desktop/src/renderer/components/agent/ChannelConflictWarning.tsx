...
/**
 * Warning component when OpenClaw channel conflicts with Headmaster Channels
 */
    ...
    <Alert
      ...
      content={
        <Space direction='vertical' size='medium' style={{ width: '100%' }}>
          <Paragraph>
            <Text bold>OpenClaw is handling {platformName} messages, not Headmaster.</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <ul>
              <li>
                <Text type='error'>✗ Switching agents in Headmaster will have no effect</Text>
              </li>
              <li>
          ...
          <Paragraph>
            <Text bold>To use Headmaster Channels and switch agents:</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <br />
            Then restart OpenClaw and Headmaster.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 2: Use a different bot</Text>
            <br />
            Create a new {platformName} bot with different credentials for Headmaster.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 3: Keep using OpenClaw</Text>
            <br />
            Disable {platformName} in Headmaster Channels and continue using OpenClaw's integration.
          </Paragraph>

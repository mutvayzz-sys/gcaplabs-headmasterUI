...
const ChannelModalContent: React.FC = () => {
  ...
  const channels: ChannelConfig[] = useMemo(() => {
    const telegramChannel: ChannelConfig = {
      ...
      description: t('settings.channels.telegramDesc', 'Chat with Headmaster assistant via Telegram'),
      status: 'active',
    ...
    const larkChannel: ChannelConfig = {
      ...
      description: t('settings.channels.larkDesc', 'Chat with Headmaster assistant via Lark or Feishu'),
      status: 'active',
    ...
    const dingtalkChannel: ChannelConfig = {
      ...
      description: t('settings.channels.dingtalkDesc', 'Chat with Headmaster assistant via DingTalk'),
      status: 'active',
    ...
    const weixinChannel: ChannelConfig = {
      ...
      description: t('settings.channels.weixinDesc', 'Chat with Headmaster assistant via WeChat'),
      status: 'active',
    ...
    const wecomChannel: ChannelConfig = {
      ...
      description: t('settings.channels.wecomDesc', 'Chat with Headmaster assistant via WeCom (Enterprise WeChat)'),
    ...
    const comingSoonChannels: ChannelConfig[] = [
      {
        ...
        description: t('settings.channels.slackDesc', 'Chat with Headmaster assistant via Slack'),
        status: 'coming_soon' as const,
        enabled: false,
        disabled: true,
        content: (
      ...
      },
      {
        ...
        description: t('settings.channels.discordDesc', 'Chat with Headmaster assistant via Discord'),
        status: 'coming_soon' as const,
        enabled: false,
        disabled: true,
        content: (
    ...
    return [
      ...
      return !['lark', 'feishu', 'dingtalk', 'weixin', 'wechat', 'wecom'].includes(id);
    });
  }, [
    pluginStatus,
    larkPluginStatus,
  ...
  const channelGuideText = t('settings.webui.featureChannelsDesc', {
    defaultValue: 'Connect Telegram, Lark, and DingTalk to interact with Headmaster from IM apps.',
  });

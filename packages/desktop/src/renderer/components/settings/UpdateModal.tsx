...
const UpdateModal: React.FC = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('headmaster-open-update-modal', handleOpenUpdateModal);

    return () => {
      removeOpenListener();
      window.removeEventListener('headmaster-open-update-modal', handleOpenUpdateModal);
    };
  }, []);

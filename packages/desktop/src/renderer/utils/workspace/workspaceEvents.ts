export const WORKSPACE_TOGGLE_EVENT = 'headmaster-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'headmaster-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'headmaster-workspace-has-files';

...
const PREVIEW_TABS_KEY = 'headmaster_preview_tabs';
const PREVIEW_ACTIVE_TAB_ID_KEY = 'headmaster_preview_active_tab_id';
const LEGACY_PREVIEW_STATE_KEY = 'headmaster_preview_state';

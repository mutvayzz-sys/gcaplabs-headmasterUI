...
export const STORAGE_KEYS = {
  ...
  WORKSPACE_TREE_COLLAPSE: 'headmaster_workspace_collapse_state',

  /** Sidebar collapse state / 侧边栏折叠状态 */
  SIDEBAR_COLLAPSE: 'headmaster_sider_collapsed',

  /** Theme preference / 主题偏好 */
  THEME: 'headmaster_theme',

  /** Language preference / 语言偏好 */
  LANGUAGE: 'headmaster_language',
} as const;

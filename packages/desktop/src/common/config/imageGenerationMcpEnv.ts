...
export const IMAGE_GEN_ENV_KEYS = {
  providerId: 'HEADMASTER_IMG_PROVIDER_ID',
  platform: 'HEADMASTER_IMG_PLATFORM',
  baseUrl: 'HEADMASTER_IMG_BASE_URL',
  apiKey: 'HEADMASTER_IMG_API_KEY',
  model: 'HEADMASTER_IMG_MODEL',
} as const;

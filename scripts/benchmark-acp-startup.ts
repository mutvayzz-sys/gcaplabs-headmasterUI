...
function getLogFilePath(): string {
  ...
  // Dev mode uses "Headmaster-Dev", production uses "Headmaster"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'Headmaster-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'Headmaster', `${today}.log`);

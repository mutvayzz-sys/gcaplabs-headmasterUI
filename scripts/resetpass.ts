 ...
 *   HEADMASTER_DATA_DIR=/x bun run resetpass
 ...
 * desktop side). Callers can override with `--port` / `HEADMASTER_PORT` to match
 ...
 * pass --port / HEADMASTER_PORT if they launched webui on a non-default one.
 */

...
function printTerminalReport(report: BenchReport): void {
  console.log('\n  ╔══════════════════════════════════════════════════════════════╗');
  console.log('  ║              Headmaster Performance Benchmark Report            ║');
  console.log('  ╚══════════════════════════════════════════════════════════════╝');
...
<head>
<meta charset="utf-8">
<title>Headmaster Benchmark Report - ${report.timestamp}</title>
<style>
...
<body>
<h1>Headmaster Performance Benchmark Report</h1>
<div class="meta">

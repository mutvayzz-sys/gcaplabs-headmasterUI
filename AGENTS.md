...
**Version:** `0.1.7` (implementation checkpoint for the Hermes-native desktop adapter; final packaged validation remains in TODO sections 15 and 16). Output filenames track this version.
...
- **Active backlog:** `todo.md` — read this first when resuming desktop work. The Hermes-native implementation is assembled at v0.1.7; remaining work is final automated validation, installed-runtime smoke testing, debugging, and release closeout.
